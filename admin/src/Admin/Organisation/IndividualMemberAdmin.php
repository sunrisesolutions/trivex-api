...
//        $query->andWhere()
    ...
    {
        $listMapper
            ->addIdentifier('admin', null, ['label' => 'form.label_is_admin'])
            ->addIdentifier('messageDeliverable', null, ['label' => 'form.label_is_message_deliverable'])
            ->addIdentifier('accessToken', null, ['label' => 'form.label_access_token'])
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper
            ->with('General')
            ->add('admin', null, ['label' => 'form.label_is_admin'])
            ->add('messageDeliverable', null, ['label' => 'form.label_is_message_deliverable'])
