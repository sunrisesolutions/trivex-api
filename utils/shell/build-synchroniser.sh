...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Doctrine/Types
cp -R -p ~/workspace/magenta/trivex/api/user/api/src/Doctrine/Types/* ~/workspace/magenta/trivex/api/synchroniser/src/Doctrine/Types

echo 'copy Entity from user'
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/User
...
sed -i -- 's/use ApiPlatform/\/\/use ApiPlatform/g' *
sed -i -- 's/@ApiResource/ApiResource/g' *
sed -i -- 's/@ApiFilter/ApiFilter/g' *
sed -i -- 's/@ApiSubresource/ApiSubresource/g' *

echo 'remove RefreshToken.php'
rm ~/workspace/magenta/trivex/api/synchroniser/src/Entity/User/RefreshToken.php

echo 'copy Repository from user'
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/User
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/Organisation
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/Organisation
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/Person
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/Person
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/Authorisation
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/Authorisation
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/Messaging
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/Messaging
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Entity/Event
...
mkdir -p ~/workspace/magenta/trivex/api/synchroniser/src/Repository/Event
